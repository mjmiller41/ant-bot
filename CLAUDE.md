...
Baseline as of this checkout: **build clean, typecheck clean, 36 test files / 665 tests passing**
(contract 22, daemon 468, ui 59, cli 116). The table in `README.md` matches; if you touch it,
