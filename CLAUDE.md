...
Baseline as of this checkout: **build clean, typecheck clean, 48 test files / 916 tests passing**
(contract 34, daemon 624, ui 115, cli 143). The table in `README.md` matches; if you touch it,
